...
public class BlutForceClient extends TablutClient {
    ...
    public BlutForceClient(String player, String name, int gameChosen, int timeout, String ipAddress, boolean deb) throws UnknownHostException, IOException {
		...
		this.debug = deb;
		System.out.println(player + " Timeout : " + timeout);
    ...
    public static void main(String[] args) throws UnknownHostException, IOException, ClassNotFoundException {
		...
		int timeout = 60;				//TODO: timeout to 60
		boolean debug = false;
		System.out.println("Len of params array "+args.length);
		if (args.length < 1) {
		...
		if (args.length > 1) {
			...
			// System.out.println("Selected timeout: " + args[1]);
		}
		if (args.length > 2) {
			ipAddress = args[2];
			// System.out.println("Selected ip address: " + args[2]);
		}
		// if (args.length == 4) {
